          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                onClick={() => {
                  if (myPeerId) {
                    setPeerIdInput(myPeerId);
                    toast({
                      title: 'Connect to Yourself',
                      description: 'Your Peer ID has been entered. Click Connect to link your devices.',
                    });
                  }
                }}
                disabled={!isInitialized || !myPeerId}
              >
                <UserCheck className="h-4 w-4 mr-2" />
                Connect to Yourself (Multi-Device Sync)
              </Button>
            </CardContent>
          </Card>
